...
export function onRequestGet(context) {
  try {
    var html = '<!DOCTYPE html>' +
      ...
      '    .api-table code { background: #f0f0f0; padding: 4px 8px; border-radius: 4px; font-family: "Consolas", monospace; font-size: 0.9em; }' +
      '    .endpoint { background: #2d3748; color: #68d391; padding: 16px; border-radius: 8px; font-family: "Consolas", monospace; margin: 12px 0; overflow-x: auto; }' +
      ...
      '        <tr><td><code>c</code></td><td>string</td><td>句子类型，如 a(动画), b(漫画), c(游戏) 等</td></tr>' +
      '        <tr><td><code>encode</code></td><td>string</td><td>返回格式: json(默认), text, js</td></tr>' +
      '        <tr><td><code>callback</code></td><td>string</td><td>JSONP 回调函数名</td></tr>' +
      '        <tr><td><code>min_length</code></td><td>number</td><td>最小句子长度</td></tr>' +
      '        <tr><td><code>max_length</code></td><td>number</td><td>最大句子长度</td></tr>' +
      '      </table>' +
